...
export default async function SetupPassword(props: PageProps<'/entrar/[token]'>) {
  ...
  return (
    <main className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center px-4 py-16">
      ...
      {validToken ? (
        <form action={setupPassword} className="mt-8 space-y-4 rounded-2xl bg-surface p-6 shadow-soft-lg">
        ...
        <div className="mt-8 rounded-2xl bg-surface p-6 text-center shadow-soft-lg">
